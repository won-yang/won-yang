...
export const getindex = async (user_id: any) => {
...
export const checkLength = (send_data: any, res: any): boolean => {
...
export const tag_name = (tag_rows: any[]): string => {
...
const check = (parm: string): string => {
