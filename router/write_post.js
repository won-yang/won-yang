...
const ID = 'AKIAIJXUFEYC63LHOOAA';
const SECRET = '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';
const BUCKET_NAME = 'wonyang-image';
const s3 = new AWS.S3({
    accessKeyId: ID,
...
router.post("/write_ok", async (req, res) => {
    ...
    await sendQuery(`INSERT INTO options VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [index, send_data.refrigerator, send_data.desk, send_data.wifi, send_data.washing_machine, send_data.gas_stove, 
              send_data.microwave, send_data.cctv, send_data.closet, send_data.bed, send_data.tv, send_data.public_washing_machine, send_data.public_kitchen, send_data.elevator, send_data.air_conditioner, send_data.door_lock])
    await sendQuery(`INSERT INTO post_content VALUES(?, ?, ?, ?, ?, ?, ?)`, [index, send_data.contact, send_data.contract_period, send_data.address, send_data.deposit, send_data.monthly_rent, send_data.content])
