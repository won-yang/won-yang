...
router.get('/admin/edit/:idx', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, permission.isAdmin(req.session.passport)];
            case 1:
                if (!(_a.sent())) {
...
router.post('/admin/edit_ok', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var post_idx, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, permission.isAdmin(req.session.passport)];
